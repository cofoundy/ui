...
export function DonutChart({
  ...
  return (
    <div data-slot="donut-chart" className={cn("flex flex-col items-center gap-3", className)}>
      ...
      >
        <div
          className={cn("absolute inset-0 rounded-full", animate && "cf-donut-reveal")}
          style={{ background: gradient }}
        />
        <div
          className="relative rounded-full bg-[var(--chat-background)] flex flex-col items-center justify-center"
